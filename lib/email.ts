...
<body style="margin: 0; padding: 20px; background-color: #f1f5f9;">
  <div style="${styles.container}">
    ...
    <div style="${styles.footer}">
      <p style="margin: 0;">Készítette: Gábor Sándor, 2026 | <a href="https://github.com/alexgabe-dev" style="${styles.link}">További munkáim</a></p>
...
export function weeklyDigestEmail({ to, ads, start, end }: { to: string; ads: any[]; start: string; end: string }) {
  ...
  const content = hasAds ? `
    ...
    <p style="${styles.text}">Kérjük, ellenőrizd a hiréseket és ha újra fel kell őket adni jelezd pls.</p>
  ` : `
